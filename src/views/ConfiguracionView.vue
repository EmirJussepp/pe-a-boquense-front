  ...
  <div class="page">
    ...
    <section class="card tab-content">
      ...
      <template v-if="tabActivo === 'tipos-socio-pena'">
        ...
        <div v-else-if="!listas['tipos-socio-pena'].length" class="empty-state">
            ...
            <tr v-for="item in listas['tipos-socio-pena']" :key="item.tipoSocioPenaId">
              ...
              <td>
                <div class="row-actions">
                  <button class="table-btn" @click="abrirEditar('tipos-socio-pena', item)">Editar</button>
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <template v-else-if="tabActivo === 'tipos-socio-boca'">
        ...
        <div v-if="loading" class="empty-state">Cargando...</div>
        <div v-else-if="!listas['tipos-socio-boca'].length" class="empty-state">
        ...
        <table v-else class="data-table">
          ...
          <tbody>
            <tr v-for="item in listas['tipos-socio-boca']" :key="item.tipoSocioBocaId">
              ...
              <td>
                <div class="row-actions">
                  <button class="table-btn" @click="abrirEditar('tipos-socio-boca', item)">Editar</button>
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <template v-else-if="tabActivo === 'salones'">
        ...
        <div v-if="loading" class="empty-state">Cargando...</div>
        <div v-else-if="!listas.salones.length" class="empty-state">
        ...
        <table v-else class="data-table">
          ...
          <tbody>
            <tr v-for="item in listas.salones" :key="item.salonId">
              ...
              <td>
                <div class="row-actions">
                  <button class="table-btn" @click="abrirEditar('salones', item)">Editar</button>
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <template v-else-if="tabActivo === 'metodos-pago'">
        ...
        <div v-if="loading" class="empty-state">Cargando...</div>
        <div v-else-if="!listas['metodos-pago'].length" class="empty-state">
      ...
      <template v-else-if="tabActivo === 'cobradores'">
        ...
        <div v-if="loading" class="empty-state">Cargando...</div>
        <div v-else-if="!listas.cobradores.length" class="empty-state">
          ...
          <div v-if="tabActivo === 'tipos-socio-pena'" class="field">
            ...
            <div class="toggle-group">
              <button
                type="button"
                class="btn-toggle"
                :class="{ 'active-success': modal.form.esVitalicio === true }"
                @click="modal.form.esVitalicio = true"
              >
                Sí
              </button>
              <button
                type="button"
                class="btn-toggle"
                :class="{ 'active-neutral': modal.form.esVitalicio === false }"
                @click="modal.form.esVitalicio = false"
              >
                No
              </button>
            </div>
...
const config = {
  ...
  cobradores: {
    ...
    defaultForm: () => ({ nombre: "", dni: "", telefono: "", zona: "" }),
  },
}
...
function yaExisteOtroVitalicio() {
  ...
  return listas["tipos-socio-pena"].some(item => {
    if (modal.editando && Number(item.tipoSocioPenaId) === Number(modal.itemId)) {
      return false
    }
...
async function guardarModal() {
  ...
  try {
    ...
    const mensaje = modal.editando ? "Cambios guardados." : "Creado correctamente."
